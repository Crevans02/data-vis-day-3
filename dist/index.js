  ...
  data: function data() {
    return {
      bundler: "Parcel"
        ...
        var $2ad5db = exports.default || module.exports;
      
      if (typeof $2ad5db === 'function') {
        $2ad5db = $2ad5db.options;
      }
    
        /* template */
        Object.assign($2ad5db, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "mx-auto text-center text-black" }, [
    _vm._v("\n    " + _vm._s(_vm.bundler) + "\n")
  ])
}
var staticRenderFns = []
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$2ad5db', $2ad5db);
          } else {
            api.reload('$2ad5db', $2ad5db);
          }
        }
